...
const frequencies = new Uint8Array(100000);
let alreadyMetFrequency = null;
let currentFrequency = 0;
let index = 0;
while (!alreadyMetFrequency) {
  currentFrequency += parsedData[index];

  if (frequencies[currentFrequency]) {
    alreadyMetFrequency = currentFrequency;
    break;
  } else {
...
console.log(alreadyMetFrequency);

console.timeEnd("Data processing");

/**
 * Another way to to it, but slower
 */
// console.time("Data processing width a Set");

// const frequenciesForSet = new Set([0]);
// let alreadyMetFrequencyForSet = null;
// let currentFrequencyForSet = 0;
// let indexForSet = 0;
// while (!alreadyMetFrequencyForSet) {
//   currentFrequencyForSet += parsedData[indexForSet];

//   if (frequenciesForSet.has(currentFrequencyForSet)) {
//     alreadyMetFrequencyForSet = currentFrequencyForSet;
//     break;
//   } else {
//     frequenciesForSet.add(currentFrequencyForSet);
//   }

//   indexForSet++;
//   if (indexForSet > length - 1) indexForSet = 0;
// }
// console.log(alreadyMetFrequencyForSet);

// console.timeEnd("Data processing width a Set");